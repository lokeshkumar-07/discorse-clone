...
import { Check, EllipsisVertical, Gavel, Loader2, MoreVertical, Shield, ShieldAlert, ShieldCheck, ShieldQuestion } from "lucide-react"
                ...
                <div key={member.id} className="flex items-center gap-x-4 mb-6">
                    ...
                    {server.profileId !== member.profileId && loadingId !== member.id && (
                        <div className="ml-auto">
                            <DropdownMenu>
                                <DropdownMenuTrigger>
                                    <EllipsisVertical className="h-4 w-4 text-zinc-500" />
                                </DropdownMenuTrigger>
